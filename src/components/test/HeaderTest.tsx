...
const HeaderTest = () => {
  ...
  return (
    <div className="bg-beige1 min-h-screen space-y-10 py-6">
      ...
      <section className="border-gray1 border-b pb-2">
        <p>2. 뒤로가기 + 중앙 텍스트</p>
        <Header variant="backTitle" title="내가 좋아요 한 콘텐츠" onBackClick={handleBack} />
      </section>

      {/* 3) 로고 + 설정 */}
      <section className="border-gray1 border-b pb-2">
        <p>3. 로고 + 설정</p>
        <Header variant="logoSetting" onLogoClick={handleLogo} onSettingClick={handleSetting} />
      </section>
      ...
      <section className="border-gray1 border-b pb-2">
        <p>5. 로고 + 북마크 아이콘</p>
        <Header variant="logoBookmark" onLogoClick={handleLogo} />
      </section>
